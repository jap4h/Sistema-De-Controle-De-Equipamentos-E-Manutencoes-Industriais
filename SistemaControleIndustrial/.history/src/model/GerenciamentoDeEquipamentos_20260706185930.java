...
public class GerenciamentoDeEquipamentos {
    ...
    public void setCodigo(int codigo) {
        // Accept only positive codes with at least 3 digits
        if (codigo > 0 && Math.abs(codigo) >= 100) {
            this.codigo = codigo;
        } else {
            System.err.println("Código inválido. Deve ser positivo e ter ao menos 3 dígitos.");
        }
    }
